...
/*   Updated: 2023/02/20 07:09:44 by jlopez-f         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::string const &Parser::getSource() const { return (_source); };
...
void	Parser::checkold(std::string &old, std::vector<std::string> &cmds)
{
